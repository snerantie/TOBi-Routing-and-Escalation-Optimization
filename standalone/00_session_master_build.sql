...
-- Sanity check (includes the new last_s_token field)
SELECT SESSION_ID, last_s_token, entity_id, intent_id, technical_topic_type, outcome_group, routed_support_type, is_technical_topic, is_hard_misroute
FROM session_master LIMIT 100;
